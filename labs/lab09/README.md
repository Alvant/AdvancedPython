...
<em>
  ...
  Зачем разожгла надежду, которой снова было суждено угаснуть?
  Медленно угаснуть.
  А пока снова болит, болит где-то в сердце.
  Разрывает.
  Зачем?
  Ромашки...
  Хотя если ещё может болеть, значит, ещё не всё потеряно.
...
Ромашек было несколько, но в результате гадания получалось ведь то же самое, что было бы с одной "большой" ромашкой, со всеми лепестками всех "обычных" ромашек...
...
Как только *одна из ромашек* в результате (то есть на последнем лепестке) скажет "любит", *весь процесс завершается*: планировщик *посылает сигналы о завершении* всем неоконченным ромашкам, сам планировщик (цикл) заканчивается, и Наташа получает своё предсказание ("любит", если нашлась описанная ромашка с ответом "любит"; иначе, после обрывания уже всех ромашек — "не любит").

*Псевдокод* (скорее, тень каркаса) описанной программы для Наташи:
```
petal_numbers <- input
