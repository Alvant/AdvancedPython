...
Утром Моне рисовал бы одну картину, днём — другую, и вечером — третью.
...
(Так Моне и работал на самом деле: "параллельно, но не одновременно" над несколькими картинами.)
...
<p align="center">
  <em>
	...
	Не приступает к новой, пока не завершит текущую.
	В асинхронном&nbsp;—&nbsp;в течение одного дня работа ведётся одновременно над несколькими картинами.
  </em>
</p>
...
Коротко и по делу про значение "синхронный" рассказано [тут](https://stackoverflow.com/questions/748175/asynchronous-vs-synchronous-execution-what-is-the-main-difference#comment57854159_748189).
