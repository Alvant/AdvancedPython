...
Но это не значит, что можно в код программы зашивать текст примера! :)

# P.P.S.

В [лабе про регулярки](http://cs.mipt.ru/advanced_python/lessons/lab12.html) много несложный упражнений.
